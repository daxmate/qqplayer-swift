...
private enum AppLogShapeContract {
    ...
    ///
    /// 批 6 曾把 `QQPlayer/Services/LibraryIndexer.swift` 与
    /// `QQPlayer/Services/LibraryIndexer+Parsing.swift` 卡住：当时的朴素子串口径把
    ...
    static let migratedChains: Set<String> = [
        ...
        "QQPlayer/Mac/MacLibraryView+Content.swift",
        "QQPlayer/Mac/MacLibraryView+Data.swift",
        "QQPlayer/Mac/MacLibraryView+Sidebar.swift",
        "QQPlayer/Mac/MacLibraryView+SyncPanel.swift",
        "QQPlayer/Mac/MacLibraryView.swift",
        "QQPlayer/Mac/MacLyricsResendAutoRunner.swift",
        "QQPlayer/Mac/MacManualEQEditorView.swift",
        "QQPlayer/Mac/MacOnlineSearchView+HistoryResults.swift",
        "QQPlayer/Mac/MacOnlineSearchView+ResultRow.swift",
        "QQPlayer/Mac/MacOnlineSearchView+SearchDownload.swift",
        "QQPlayer/Mac/MacOnlineSearchView.swift",
        "QQPlayer/Mac/MacPlaylistDetailSheet.swift",
        "QQPlayer/Mac/MacQuarkLoginView.swift",
        "QQPlayer/Mac/MacSearchAnythingLayer+Rows.swift",
        "QQPlayer/Mac/MacSearchAnythingLayer+SearchTop.swift",
        "QQPlayer/Mac/MacSearchAnythingLayer+WindowTricks.swift",
        ...
        "QQPlayer/Services/AppCoordinator+Siri.swift",
        ...
        "QQPlayer/Services/DatabaseManager+LibraryCRUD.swift",
        "QQPlayer/Services/DatabaseManager+LibraryMigrations.swift",
        "QQPlayer/Services/DatabaseManager+Migration.swift",
        "QQPlayer/Services/DatabaseManager+PlaylistFolderSync.swift",
        "QQPlayer/Services/DatabaseManager+PlaylistMaintenance.swift",
        ...
        "QQPlayer/Services/EQManager+Presets.swift",
        ...
        "QQPlayer/Services/IOSPassiveSyncCenter+Models.swift",
        "QQPlayer/Services/IOSPassiveSyncCenter+Reconnect.swift",
        "QQPlayer/Services/IOSPassiveSyncCenter.swift",
        "QQPlayer/Services/KaraokeController.swift",
        "QQPlayer/Services/LibraryIndexer+Parsing.swift",
        "QQPlayer/Services/LibraryIndexer+Scanning.swift",
        "QQPlayer/Services/LibraryIndexer+SharedImport.swift",
        "QQPlayer/Services/LibraryIndexer.swift",
        ...
        "QQPlayer/Services/PlayerEngine+AudioEngineSetup.swift",
        "QQPlayer/Services/PlayerEngine+AudioScheduling.swift",
        "QQPlayer/Services/PlayerEngine+AudioSession.swift",
        "QQPlayer/Services/PlayerEngine+AudioSessionEvents.swift",
        "QQPlayer/Services/PlayerEngine+NowPlaying+Artwork.swift",
        "QQPlayer/Services/PlayerEngine+NowPlaying+ArtworkID3.swift",
        "QQPlayer/Services/PlayerEngine+NowPlaying+Mac.swift",
        "QQPlayer/Services/PlayerEngine+NowPlaying+Widget.swift",
        "QQPlayer/Services/PlayerEngine+NowPlaying.swift",
        "QQPlayer/Services/PlayerEngine+PlaybackControl+Mac.swift",
        "QQPlayer/Services/PlayerEngine+PlaybackControl+Seek.swift",
        "QQPlayer/Services/PlayerEngine+PlaybackControl+Transport.swift",
        ...
        "QQPlayer/Services/QuarkClient+CookieHTTP.swift",
        "QQPlayer/Services/QuarkClient+Share.swift",
        ...
        "QQPlayer/Services/SyncChangeLogDanglingRepair.swift",
        ...
        "QQPlayer/Sync/SyncChangeLogMapper.swift",
        ...
        "QQPlayer/Views/Library/LibraryView+ImportSupport.swift",
        "QQPlayer/Views/Library/LibraryView+ResponsiveFonts.swift",
        "QQPlayer/Views/Library/LibraryView+SectionRendering.swift",
        "QQPlayer/Views/Library/LibraryView+SectionRow.swift",
        "QQPlayer/Views/Library/LibraryView+SyncFeedback.swift",
        "QQPlayer/Views/Library/LibraryView.swift",
        "QQPlayer/Views/Library/SearchResultsViews+AlbumRow.swift",
        "QQPlayer/Views/Library/SearchResultsViews+ArtistRows.swift",
        "QQPlayer/Views/Library/SearchResultsViews+PlaylistRow.swift",
        "QQPlayer/Views/Library/SearchResultsViews+SongRow.swift",
        ...
        "QQPlayer/Views/Playlists/PlaylistDetailScreen+DataLoading.swift",
        "QQPlayer/Views/Playlists/PlaylistDetailScreen+PlaybackActions.swift",
        "QQPlayer/Views/Playlists/PlaylistDetailScreen+Sorting.swift",
    ...
    /// `NSLog(` 计数：复用 `StructuralBudgetRule` 的**同一份词边界口径**
    /// （`callOccurrences`——**不另写一份 print/NSLog 计数正则**；剥注释口径与 `printCalls` 一致）。
    static func nsLogCalls(in source: String) -> Int {
        source
            ...
            .reduce(0) { partial, rawLine in
                ...
                return partial + StructuralBudgetRule.callOccurrences(of: "NSLog(", in: code)
            }
    }
